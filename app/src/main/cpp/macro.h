...
#ifndef FFJNIPLAYER_MACRO_H
#define FFJNIPLAYER_MACRO_H
...
//定义日志打印宏函数
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR, "FFJNIPlayer",__VA_ARGS__)
